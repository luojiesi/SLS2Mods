...
| Hover | Shows |
|-------|-------|
| A hand card in combat | the cards it will generate / offer (Discovery, Infernal Blade, Quasar, Jackpot, ...), the card it will pick from your hand or piles (True Grit, Cinder, Thrash, Seeker Strike, Beat Down, Catastrophe, ...), the enemies each hit will land on (Sword Boomerang, Ricochet, Flak Cannon, Volley, Bouncing Flask, ...), orbs (Chaos), potions (Alchemize), and for the Defect every card that channels or evokes (Zap, Dualcast, Tempest, Multi-Cast, Rainbow, Glacier, ...): which enemy each Lightning evoke and end-of-turn passive will hit, orbs pushed out of full slots included, kills removed from later draws |
